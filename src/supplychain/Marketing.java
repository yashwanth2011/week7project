...
public class Marketing extends Services{
    ...
    public Marketing(double Price_Per_Anum, String[] Distributed_Area, String Name, String Type, int Years, Company company) {
